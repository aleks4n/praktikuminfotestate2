...
int main()
{
    ...
    do  // Anzeige des Men�s
    {
        std::cout << std::endl
				  ...
				  << "(6): Ausgeliehne Mediums Ausgeben" << std::endl
                  << "(7): Beenden" << std::endl;
...
void fuelleDatenbank(std::vector<Medium*>& medien)
{
#if UNTERKLASSENVORHANDEN
    {
        ...
        neuesMedium = new Magazin("Chip", Datum(16, 05, 2023), "Computer");
        medien.push_back(neuesMedium);
      ...
      //  neuesMedium = new Medium("Medium Versuch");
       // medien.push_back(neuesMedium);
    }
#else
    {
...
void ausgelieheneAusgeben(std::vector<Medium*>& medien)
{
    std::cout << "Ausgeliehen Medien:" << std::endl;
